...
class InicioScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("fondoInicio","fondo01.png");
    }
    ...
    create(){
        ...
        // Título del juego
        this.add.text(180,200,"TRIVIA DE BURBUJAS",{
            fontSize:"28px",
            color:"#ffffff"
...
class TriviaScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("fondoJuego","fondo02.png");
    }
    ...
    create(){
        ...
        this.preguntas = [
            {pregunta:"¿Por qué son redondas?", opciones:["a) Gravedad", "b) Tensión superficial","c) Viento","d) Magnetismo"], correcta:1},
            {pregunta:"¿Qué causa sus colores?", opciones:["a) Tinta", "b) Reflexión de luz","c) Jabón","d) Frío"], correcta:1},
            {pregunta:"¿Qué líquido las ayuda a durar más?", opciones:["a) Glicerina", "b) Sal","c) Aceite","d) Alcohol"], correcta:0},
            {pregunta:"¿Qué gas hay dentro de una típica?", opciones:["a) Helio", "b) Oxígeno puro","c) Aire","d) CO2"], correcta:2},
            {pregunta:"¿Qué pasa si la tocas con la mano seca?", opciones:["a) Se estira", "b) Explota ","c) Gira ","d) Se pone roja"], correcta:1},
            {pregunta:"¿Cómo son en el espacio? ", opciones:["a) No existen ", "b) Perfectas esferas ","c) Cuadradas  ","d) Se congelan "], correcta:1},
            {pregunta:"¿Cuál es el mejor clima?", opciones:["a) Calor seco ", "b) Lluvia ácida","c) Viento fuerte ","d) Frío y húmedo "], correcta:3},
            {pregunta:"¿Récord de tamaño? ", opciones:["a) 1 metro ", "b) 500 metros ","c) 30 metros ","d) 100 metros "], correcta:2},
        ];

        // Texto de vidas y puntaje
        this.textoVidas = this.add.text(20,20,"🫧".repeat(this.vidas),{fontSize:"18px"});
